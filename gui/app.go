...
// SetSettings stores the GUI state. Changing the role only affects which
// process the main Start/Stop controls; nothing is started or stopped
// here, and the client address may stay empty until the client is
// actually started (start validates it).
